            ...
            $query = "SELECT * FROM tbl_hospital ";  
                ...
                {  
                    while($row=$result->fetch_array())  
                    {
                            ...
                            $h_desc=$row['h_desc'];
                            $h_ratings=$row['h_ratings'];
                            $h_timings=$row['h_timings'];
                  ...
                  ?>
                                                ...
                                                <tr>
                                                    <td><a href="#"><span class="list-enq-name"><?php echo $h_name;?></span>
                                                        <!--<span class="list-enq-city">Illunois, United States</span>--></a>
                                                    </td>
                                                    <td><?php echo $h_address;?></td>
                                                    <td><?php echo $h_contact;?></td>
                                                    <td><?php echo $h_desc;?></td>
                                                    <td><?php echo $h_timings;?></td>
                                                    <td><?php echo $h_website;?></td>
                                                    <td><a href="view_hospitals.php?View=<?php echo $row['h_id']; ?>">
                                                    ...
                                                    <td>
                                                            ...
                                                            <form action="delete_hospitals.php" method="POST">
                                                            <input type="hidden" value="<?php echo $row['h_id' ] ?>" name=h_id>
