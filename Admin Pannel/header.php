  <div class="container-fluid sb1">
        <div class="row">
            ...
            <!--== MY ACCCOUNT ==-->
            <div class="col-md-2 col-sm-3 col-xs-6" style="float: right;">
                <!-- Dropdown Trigger -->
                ...
                <ul id='top-menu' class='dropdown-content top-menu-sty'>
                    <li><a href="all_cities.php">All Cities</a>
                                    </li>
                                    
                    <li><a href="users.php" class="waves-effect">All Users</a>
                    </li>
                     <li>
                        <a href="view_type_of_places.php">All Types Of Places</a>
                                    </li>
