                ...
                {  
                  ...
                  ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="#"><span class="list-enq-name"><?php echo $a_name;?></span>
                                                        <!--<span class="list-enq-city">Illunois, United States</span>--></a>
                                                    </td>
                                                     <td><?php echo $a_desc;?></td>
                                                   
                                                    <td><?php echo $a_address;?></td>
                                                    <td><?php echo $a_image;?></td>
                                                    <td><?php echo $a_timings;?></td>
                                                    <td><?php echo $t_id;?></td>
                                                    

                                                    <td><a href="view_attraction.php?View=<?php echo $row['a_id']; ?>">
                                                    ...
                                                    <td>
                                                            ...
                                                            <form action="delete_attractions.php" method="POST">
                                                            <input type="hidden" value="<?php echo $row['a_id' ] ?>" name=a_id>
